...
namespace lab3_Layth_alshareefi.NorthwindDataSetTableAdapters {
...
SELECT OrderID, ProductID, UnitPrice, Quantity, Discount FROM [Order Details] WHERE (OrderID = @OrderID) AND (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::lab3_Layth_alshareefi.Properties.Settings.Default.NorthwindConnectionString;
        }
